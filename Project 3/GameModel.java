...
public abstract class GameModel {
	...
	public GameModel(int rows, int cols) {
		...
		// Filling the rectangular with BoardCell.EMPTY cells
		
		for(int rectangularRows=0; rectangularRows<board.length;rectangularRows++) {
		
			for(int rectangularColumns=0; rectangularColumns<board[rectangularRows].length; rectangularColumns++) {
				
				board[rectangularRows][rectangularColumns]=BoardCell.EMPTY;
